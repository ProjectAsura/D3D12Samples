...
#define ASDX_WIDE( _string )        __ASDX_WIDE( _string )
    ...
    #define ASDX_IS_SSE     (1)     // SSE有効.
#else
    #define ASDX_IS_SSE     (0)     // SSE無効.
#endif

#if defined(__AVX__)
    #define ASDX_IS_AVX     (1)     // AVX有効.
#else
    #define ASDX_IS_AVX     (0)     // AVX無効.
#endif

#if defined(__AVX2__)
    #define ASDX_IS_AVX2    (1)     // AVX2有効.
#else
    #define ASDX_IS_AVX2    (0)     // AVX2無効.
#endif
...
typedef FixedArray<bool, 2>      bool2;
typedef FixedArray<bool, 3>      bool3;
typedef FixedArray<bool, 4>      bool4;

typedef FixedArray<s8, 2>        sbyte2;
typedef FixedArray<s8, 3>        sbyte3;
typedef FixedArray<s8, 4>        sbyte4;

typedef FixedArray<u8, 2>        byte2;
typedef FixedArray<u8, 3>        byte3;
typedef FixedArray<u8, 4>        byte4;

typedef FixedArray<u16, 2>       ushort2;
typedef FixedArray<u16, 3>       ushort3;
typedef FixedArray<u16, 4>       ushort4;

typedef FixedArray<s16, 2>       short2;
typedef FixedArray<s16, 3>       short3;
typedef FixedArray<s16, 4>       short4;

typedef FixedArray<s32, 2>       int2;
typedef FixedArray<s32, 3>       int3;
typedef FixedArray<s32, 4>       int4;

typedef FixedArray<u32, 2>       uint2;
typedef FixedArray<u32, 3>       uint3;
typedef FixedArray<u32, 4>       uint4;

typedef FixedArray<s64, 2>       long2;
typedef FixedArray<s64, 3>       long3;
typedef FixedArray<s64, 4>       long4;

typedef FixedArray<u64, 2>       ulong2;
typedef FixedArray<u64, 3>       ulong3;
typedef FixedArray<u64, 4>       ulong4;

typedef FixedArray<f32, 2>       float2;
typedef FixedArray<f32, 3>       float3;
typedef FixedArray<f32, 4>       float4;

typedef FixedArray<f64, 2>       double2;
typedef FixedArray<f64, 3>       double3;
typedef FixedArray<f64, 4>       double4;
